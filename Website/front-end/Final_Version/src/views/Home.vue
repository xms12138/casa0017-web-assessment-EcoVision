<template>
  <div class="home">
    ...
    <div class="stats">
      ...
      <div>
        AQI AVG: <span class="stat-val">{{ currentAQI }}</span>
      </div>
    ...
    <div id="content">
      ...
      <div class="section">
        <div class="box">
          <h2>🌍 OUR MISSION</h2>
          <p>
            EcoVision London is a cutting-edge air quality monitoring platform
            that visualizes pollution data from major cities worldwide.
          </p>
          <p>
            Using advanced sensors and data analytics, we track PM2.5, CO2, CO
            and traffic flow.
          </p>
      ...
      <div class="section">
        <div class="box">
          <h2>⚙️ TECHNOLOGY</h2>
          <p>
            Our platform leverages mapbox an open-source WebGL library that
            renders stunning 3D geographical data visualizations.
          </p>
          <p>
            The interactive London map real-time data with color-coded markers
            indicating air quality levels.
          </p>
      ...
      <div class="section">
        <div class="box">
          <h2>🎯 GLOBAL IMPACT</h2>
          <p>
            Air pollution affects millions of lives worldwide. EcoVision London
            makes pollution data accessible and actionable for everyone.
          </p>
          <p>
            Join us in our mission to create awareness and drive change towards
...
const initGlobe = () => {
  try {
    ...
    globe
      ...
      .backgroundImageUrl(
        "https://unpkg.com/three-globe@2.27.2/example/img/night-sky.png"
      );
    ...
    globe
      ...
      .pointLabel(
        (d) =>
          `<div style="background:#000;padding:12px;border:2px solid #a855f7;font-family:'Press Start 2P';font-size:10px;color:#a855f7;"><b style="color:#fff;font-size:11px;">🌆 ${
            d.name
          }</b><br/><b>AQI:</b> <span style="color:${getColor(
            d.aqi
          )};font-size:14px;">${d.aqi}</span><br/><b>Status:</b> ${getStatus(
            d.aqi
          )}</div>`
      );
    log("✓ Cities added");
    ...
    globe
      ...
      .pointOfView({ lat: 30, lng: 0, altitude: 2.2 }, 0);
    log("✓ View configured");
